...
const nightOverlayOpacity = computed(() => {
  ...
  return Math.min(0.7, actualScroll / 650)
})
...
<template>
  ...
  <div v-show="showParallax" class="parallax-wrap">
    ...
    <template v-else>
      <!-- Night sky replaces the daytime sky/sun/cloud layers (1-3) -->
      <div class="parallax-item parallax-night-sky">
        <img
          fetchpriority="high"
          src="/evening/night-sky.webp"
          alt=""
        >
      </div>

      <!-- Shared foreground silhouette layers (4–14) — same as daytime, work on any sky -->
